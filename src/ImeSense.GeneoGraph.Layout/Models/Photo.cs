...
public class Photo : ReactiveObject {
    ...
    public void LoadImage() {
        if (Uri.TryCreate(_filePath, UriKind.RelativeOrAbsolute, out var uri)) {
            ...
            var defaultUriPath = "avares://ImeSense.GeneoGraph.Layout/Assets/Profile/Profile_picture.png"; //Loading some default image if there is none
    ...
    public static ObservableCollection<Photo> PhotosList { get; set; } = new()
{
        new Photo
        {
            ...
            FilePath = "avares://ImeSense.GeneoGraph.Layout/Assets/Profile/Profile_picture.png",
        },
        new Photo
        {
            PhotoId = 2,
            ...
            FilePath = "avares://ImeSense.GeneoGraph.Layout/Assets/Profile/Profile_picture2.png",
            IsFavorite = true
        ...
        new Photo
        {
            ...
            FilePath = "avares://ImeSense.GeneoGraph.Layout/Assets/Profile/Profile_picture3.png",
            IsFavorite = true
        ...
        new Photo
        {
            ...
            FilePath = "avares://ImeSense.GeneoGraph.Layout/Assets/Profile/Profile_picture4.png",
            IsFavorite = true
